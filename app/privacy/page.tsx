            ...
            <main className="flex-1">
                <div className="container mx-auto px-4 py-8 max-w-4xl">
                    <div className="prose prose-lg max-w-none">
                        <h1 className="text-4xl font-bold text-white-900 mb-8">Privacy Policy</h1>
                        <p className="text-white-600 mb-8">Last updated: {new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</p>

                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-white-900 mb-4">Introduction</h2>
                        ...
                        <section className="mb-8">
                            ...
                            <div className="mb-6">
                                <h3 className="text-xl font-medium text-white-900 mb-3">Personal Information</h3>
                                <p className="text-white-700 leading-relaxed mb-4">
                                    We collect personal information that you voluntarily provide when using our service:
                                </p>
                                <ul className="list-disc list-inside text-white-700 space-y-2 mb-4">
                            ...
                            <div className="mb-6">
                                <h3 className="text-xl font-medium text-white-900 mb-3">Automatically Collected Information</h3>
                                <p className="text-white-700 leading-relaxed mb-4">
                            ...
                            <div className="mb-6">
                                <h3 className="text-xl font-medium text-white-900 mb-3">Website Analysis Data</h3>
                                <p className="text-white-700 leading-relaxed mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-white-900 mb-4">3. Information Sharing and Disclosure</h2>
                            <p className="text-white-700 leading-relaxed mb-4">
                                We do not sell, trade, or rent your personal information to third parties. We may share your information in the following circumstances:
                            </p>

                            <div className="mb-6">
                                <h3 className="text-xl font-medium text-white-900 mb-3">Service Providers</h3>
                                <p className="text-white-700 leading-relaxed mb-4">
                            ...
                            <div className="mb-6">
                                <h3 className="text-xl font-medium text-white-900 mb-3">Legal Requirements</h3>
                                <p className="text-white-700 leading-relaxed mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-white-900 mb-4">5. Data Retention</h2>
                            <p className="text-white-700 leading-relaxed mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-white-900 mb-4">6. Your Privacy Rights</h2>
                            <p className="text-white-700 leading-relaxed mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-white-900 mb-4">7. Cookies and Tracking Technologies</h2>
                            <p className="text-white-700 leading-relaxed mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-white-900 mb-4">8. International Data Transfers</h2>
                            <p className="text-white-700 leading-relaxed mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-white-900 mb-4">9. Children's Privacy</h2>
                            <p className="text-white-700 leading-relaxed mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-white-900 mb-4">10. Changes to This Privacy Policy</h2>
                            <p className="text-white-700 leading-relaxed mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-white-900 mb-4">11. Contact Us</h2>
                            <p className="text-white-700 leading-relaxed mb-4">
                                If you have questions about this Privacy Policy or our privacy practices, please contact us:
                            </p>
                            <div className="bg-white-50 p-4 rounded-lg">
                                <p className="text-white-700 mb-2"><strong>Email:</strong> privacy@llmcheck.app</p>
                                <p className="text-white-700 mb-2"><strong>Website:</strong> <a href="https://llmcheck.app" className="text-blue-600 hover:underline">www.llmcheck.app</a></p>
                            </div>
                        </section>
