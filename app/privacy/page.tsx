                ...
                <div className="container mx-auto px-4 py-8 max-w-4xl">
                    <div className="prose prose-lg max-w-none">
                        ...
                        <section className="mb-8">
                            ...
                            <div className="mb-6">
                                <h3 className="text-xl font-medium text-gray-900 mb-3">Website Analysis Data</h3>
                                <p className="text-gray-700 leading-relaxed mb-4">
                        ...
                        <section className="mb-8">
                            ...
                            <div className="bg-gray-50 p-4 rounded-lg">
                                <p className="text-gray-700 mb-2"><strong>Email:</strong> privacy@llmcheck.app</p>
                                <p className="text-gray-700 mb-2"><strong>Website:</strong> <a href="https://llmcheck.app" className="text-blue-600 hover:underline">www.llmcheck.app</a></p>
                            </div>
                        </section>
