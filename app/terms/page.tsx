                ...
                <div className="container mx-auto px-4 py-8 max-w-4xl">
                    <div className="prose prose-lg max-w-none">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-blue-900 mb-4">Welcome to LLM Ready</h2>
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-blue-900 mb-4">1. Service Description</h2>
                            <p className="text-gray-500 leading-relaxed mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-blue-900 mb-4">2. User Accounts and Registration</h2>
                            <p className="text-gray-500 leading-relaxed mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-blue-900 mb-4">3. Subscription Plans and Billing</h2>
                            <p className="text-gray-500 leading-relaxed mb-4">
                                LLM Ready offers both free and premium subscription plans:
                            </p>
                            <div className="mb-4">
                                <h3 className="text-xl font-medium text-blue-900 mb-2">Free Plan</h3>
                            ...
                            <div className="mb-4">
                                <h3 className="text-xl font-medium text-blue-900 mb-2">Premium Plan</h3>
                                <ul className="list-disc list-inside text-gray-500 space-y-1 mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-blue-900 mb-4">4. Acceptable Use</h2>
                            <p className="text-gray-500 leading-relaxed mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-blue-900 mb-4">5. Data and Privacy</h2>
                            <p className="text-gray-500 leading-relaxed mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-blue-900 mb-4">6. Intellectual Property</h2>
                            <p className="text-gray-500 leading-relaxed mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-blue-900 mb-4">7. Disclaimer of Warranties</h2>
                            <p className="text-gray-500 leading-relaxed mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-blue-900 mb-4">8. Limitation of Liability</h2>
                            <p className="text-gray-500 leading-relaxed mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-blue-900 mb-4">9. Termination</h2>
                            <p className="text-gray-500 leading-relaxed mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-blue-900 mb-4">10. Changes to Terms</h2>
                            <p className="text-gray-500 leading-relaxed mb-4">
                        ...
                        <section className="mb-8">
                            ...
                            <div className="bg-gray-50 p-4 rounded-lg">
                                <p className="text-gray-500 mb-2"><strong>Email:</strong> legal@llmcheck.app</p>
                                <p className="text-gray-500 mb-2"><strong>Website:</strong> <a href="https://llmcheck.app" className="text-blue-600 hover:underline">llmcheck.app</a></p>
                                <p className="text-gray-500"><strong>Support:</strong> support@llmcheck.app</p>
                            </div>
                        </section>

                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-blue-900 mb-4">12. Governing Law</h2>
