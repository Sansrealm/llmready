        ...
        <article itemScope itemType="https://schema.org/TechArticle">
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="lg:w-3/4 order-1 lg:order-2">
              <div className="prose prose-lg max-w-none dark:prose-invert prose-headings:text-gray-900 dark:prose-headings:text-gray-100 prose-p:text-gray-700 dark:prose-p:text-gray-300 prose-li:text-gray-700 dark:prose-li:text-gray-300">
                <h1 itemProp="headline" className="text-4xl font-bold mb-6 text-gray-900 dark:text-gray-50">
                  {guideMetadata.title}
                </h1>

                <p itemProp="description" className="text-xl text-gray-600 dark:text-gray-400 italic mb-6">
                  Your website just got analyzed by llmcheck.app. What's next? Here's how to turn those insights into action.
                </p>

                <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500 dark:text-gray-400 mb-8 border-b border-gray-100 dark:border-gray-800 pb-4">
                  {/* Publication Info */}
                  <div className="flex items-center gap-2">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                    <time itemProp="datePublished" dateTime={guideMetadata.publishedDate}>
                      First published: {new Date(guideMetadata.publishedDate).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}
                    </time>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <time itemProp="dateModified" dateTime={guideMetadata.modifiedDate}>
                      Last updated: {new Date(guideMetadata.modifiedDate).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}
                    </time>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>{guideMetadata.estimatedReadingTime} read</span>
                  </div>
